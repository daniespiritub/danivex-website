...
export function generatePlayerFromLookup(uid, lookup) {
  ...
  const player = {
    ...
    pass: lookup?.pass || '',
    clan: lookup?.clan || '',
    clanId: lookup?.clanId || '',
    clanLevel: lookup?.clanLevel || '',
    clanMembers: lookup?.clanMembers || '',
    emulator: lookup?.emulator || '',
    elitePass: lookup?.elitePass || '',
    season: lookup?.season || '',
    rankBR: lookup?.rankBR || '',
    rankBRDivision: lookup?.rankBRDivision || '',
    rankBRStarLevel: lookup?.rankBRStarLevel || '',
    rankBRPointsToNext: lookup?.rankBRPointsToNext || '',
    rankBRNextThreshold: lookup?.rankBRNextThreshold || '',
    rankBRPoints: lookup?.rankBRPoints || '',
    rankBRCode: lookup?.rankBRCode || '',
    rankBRTierKey: lookup?.rankBRTierKey || '',
    rankCS: lookup?.rankCS || '',
    rankCSDivision: lookup?.rankCSDivision || '',
    rankCSStars: lookup?.rankCSStars || '',
    rankCSSeason: lookup?.rankCSSeason || '',
    rankCSRawValue: lookup?.rankCSRawValue || '',
    rankCSCode: lookup?.rankCSCode || '',
    ...
    enrichment: Array.isArray(lookup?.enrichment) ? lookup.enrichment : [],
    pet: lookup?.pet || '',
    petNickname: lookup?.petNickname || '',
    petSkinName: lookup?.petSkinName || '',
