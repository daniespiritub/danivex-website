export const knowledge = [
  { title: 'VEXA y modulos', url: 'https://danivex.com/', text: 'VEXA y los modulos son planes futuros. No hay un catalogo publico verificado de modulos, licencias, compatibilidades ni artefactos VEXA disponible en esta fase. No inventar funciones, requisitos, fechas ni enlaces de descarga. Para productos existentes consulta solo la documentacion publicada de DaniVex.' },
