...
export const reservedHandles = new Set('admin administrator root support staff official danivex api auth account login register signup signin settings android modules download downloads security verify system'.split(' '))
